...
class CertificateParameters(BaseModel):
    ...
    RROLL: str = Field(..., description='Roll No.', examples=['173XX23'])
    RROLL_CODE: str = Field(..., description='Roll Code', examples=['11XX1'])
    year: str = Field(..., description='Year', examples=['2018,2019'])
